...
// //
// // import 'VIEW.dart';
// // import 'daycare enrool.dart';
// //
// // class ChoosingDaycare extends StatefulWidget {
// //   const ChoosingDaycare({super.key});
// //
// //   @override
...
// //                       crossAxisSpacing: 20,
// //                       childAspectRatio:
// //                           .95, // Adjust this ratio to control item size
// //                     ),
...
// //                           _showDaycareDetail(
// //                             context,
// //                             enroll[index]["Username"],
// //                             enroll[index]["PreschoolAddress"],
// //                             enroll[index]["Phone"],
// //                             enroll[index]["certificate"],
// //                             enroll[index].id,
// //                           );
// //                         },
// //                         child: Container(
...
class _ChoosingDaycareState extends State<ChoosingDaycare> {
  ...
  Future<dynamic> ParentReg() async {
    await FirebaseFirestore.instance.collection("ParentRegister").add({
      ...
      "Daycare name": selectedDaycareId,
